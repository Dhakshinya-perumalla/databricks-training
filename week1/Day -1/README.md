...
Overview
Today I started my Databricks training journey by setting up the GitHub repository and practicing basic SQL concepts.

##  Tasks Completed
- Repository Setup
- Created GitHub repository
- Created week-wise and day-wise folder structure
...
- How to create and insert data into tables
